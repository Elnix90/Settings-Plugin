...
/**
 * Creates an [EnumSettingObject] with a title and description.
 *
 * This function is used to define an enum setting in a type-safe way.
 ...
 * @param default The default enum value for the setting.
